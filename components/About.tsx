...
const About = () => {
  return (
    ...
    >
      <div>
        <h2 className="text-primary mb-4 text-sm">ABOUT</h2>
      ...
      <div className="mt-8 flex justify-end gap-4">
        ...
        <button className="text-secondary rounded-2xl border bg-neutral-400 p-2 transition-colors hover:bg-zinc-700 dark:bg-zinc-800">
